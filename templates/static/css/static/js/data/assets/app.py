...
# Configure Flask to use the top-level workspace templates/static folders
BASE_TEMPLATES_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..','..','..','..','..','..'))
app = Flask(__name__, template_folder=BASE_TEMPLATES_DIR, static_folder=os.path.join(BASE_TEMPLATES_DIR, 'static'))
CORS(app)
...
def login():
    ...
    if request.method == 'POST':
        ...
        # Hardcoded credentials for prototype (CHANGE for production)
